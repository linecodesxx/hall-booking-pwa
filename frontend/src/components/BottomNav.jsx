import { CalendarDays, ClipboardList, DoorOpen, Plus, Users } from 'lucide-react';

export function BottomNav({ user, route, go }) {
  const items = user.role === 'admin'
    ? [['/schedule', CalendarDays, 'Расписание'], ['/new-booking', Plus, 'Новая'], ['/admin/bookings', ClipboardList, 'Все брони'], ['/admin/halls', DoorOpen, 'Помещения'], ['/admin/users', Users, 'Пользователи']]
